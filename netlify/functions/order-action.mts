...
const transitions: Record<string, Transition> = {
  ...
  PROOF_SENT: { status: 'WAITING_CUSTOMER_APPROVAL', owner: 'Egnali', nextAction: 'Approval follow-up every other business day', waiting: true, followBusinessDays: 2, followUpOwner: 'Egnali', followUpStage: 'APPROVAL' },
